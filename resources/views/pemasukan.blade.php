    ...
    <main class="main-content">
        ...
        <div class="form">
            ...
            <div class="target-barang-container">
                ...
                <div id="targetBarangDropdown" style="display: none; margin-top: 10px;">
                    <select id="targetBarangSelect">
                        <option value="">Pilih Target Barang</option>
                        <!-- Target barang akan diisi dengan JavaScript -->
                    </select>
                    <div style="margin-top: 1em" id="formattedTextTargetBarang">Rp 0</div>
                    <input type="number" id="nominalTargetBarang" placeholder="Masukkan nominal" style="margin-top: 10px;" oninput="updateFormattedTextTargetBarang()">
                </div>
            </div>

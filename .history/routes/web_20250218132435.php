...
Route::middleware([UserIsAuthenticated::class])->group(function () {
    ...
    Route::prefix('menejemen_anggaran/')->group(function(){
        ...
        Route::prefix('kategori/')->group(function(){
            ...
            Route::get('/edit/{type}/{id}', [PemasukanPengeluaranController::class, 'EditByKategori'])->name('edit.pemasukan.pengeluaran.page');
            // Rute untuk memperbarui data
            Route::put('/update/{type}/{id}', [PemasukanPengeluaranController::class, 'update'])->name('update.pemasukan.pengeluaran');        });
    });

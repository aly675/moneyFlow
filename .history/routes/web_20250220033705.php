...
Route::middleware([UserIsAuthenticated::class])->group(function () {
    ...
    Route::prefix('target-barang')->group(function () {
        Route::get('/', [TargetBarangController::class, 'index'])->name('target.barang.page');
        Route::get('/create', [TargetBarangController::class, 'create'])->name('target.barang.create');
        Route::post('/', [TargetBarangController::class, 'store'])->name('target.barang.store');

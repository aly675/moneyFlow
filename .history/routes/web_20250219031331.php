...
Route::middleware([RedirectIfAuthenticated::class])->group(function () {
    ...
    Route::get('/loginRegis', [AuthController::class, 'showLoingRegisForm'])->name('register_page');
    Route::post('/loginRegis', [AuthController::class, 'register'])->name('register.submit');
    Route::post('/loginRegis', [AuthController::class, 'login'])->name('login_submit');
});

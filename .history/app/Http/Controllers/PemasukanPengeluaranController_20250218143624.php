...
class PemasukanPengeluaranController extends Controller
{
    ...
    public function simpanPengeluaran(Request $request)
    {
      ...
      public function updateData(Request $request, $id, $type)
      {
          ...
          $data->title = $request->input('judul'); // Menggunakan 'title' untuk menyimpan judul
          $data->deskripsi = $request->input('catatan'); // Menggunakan 'deskripsi' untuk menyimpan catatan
          $data->save();

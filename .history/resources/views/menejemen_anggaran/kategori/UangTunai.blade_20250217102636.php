        ...
        <div class="main-container">
            <div class="dropdown-container">
                ...
                <div class="dropdown-content " id="paymentOptions">
                  <div class="payment-option selected"><a href="{{route('')}}">Uang Tunai</a></div>
                  <div class="payment-option"><a href="{{route('')}}">BRI</a></div>
                  <div class="payment-option"><a href="{{route('')}}">Mandiri</a></div>
                  <div class="payment-option"><a href="{{route('')}}">Dana</a></div>
                  <div class="payment-option"><a href="{{route('')}}">BCA</a></div>
                  <div class="payment-option"><a href="{{route('')}}">Gopay</a></div>
                </div>
            </div>

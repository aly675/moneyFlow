        ...
        <div class="main-container">
            <div class="dropdown-container">
                ...
                <div class="dropdown-content " id="paymentOptions">
                  <div class="payment-option selected"><a href="{{route('kategori.UangTunai')}}">Uang Tunai</a></div>
                  <div class="payment-option"><a href="{{route('kategori.BRI')}}">BRI</a></div>
                  <div class="payment-option"><a href="{{route('kategori.')}}">Mandiri</a></div>
                  <div class="payment-option"><a href="{{route('kategori.')}}">Dana</a></div>
                  <div class="payment-option"><a href="{{route('kategori.')}}">BCA</a></div>
                  <div class="payment-option"><a href="{{route('kategori.')}}">Gopay</a></div>
                </div>
            </div>

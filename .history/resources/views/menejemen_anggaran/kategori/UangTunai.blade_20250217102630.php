        ...
        <div class="main-container">
            <div class="dropdown-container">
                ...
                <div class="dropdown-content " id="paymentOptions">
                  <div class="payment-option selected"><a href="{{}}">Uang Tunai</a></div>
                  <div class="payment-option"><a href="{{}}">BRI</a></div>
                  <div class="payment-option"><a href="{{}}">Mandiri</a></div>
                  <div class="payment-option"><a href="{{}}">Dana</a></div>
                  <div class="payment-option"><a href="{{}}">BCA</a></div>
                  <div class="payment-option"><a href="{{}}">Gopay</a></div>
                </div>
            </div>

    ...
    <div class="header">
        ...
        <div class="form">
            <form action="{{ route('update.pemasukan.pengeluaran', ['type' => $type, 'id' => $data->id]) }}" method="POST">
                ...
                <input type="text" name="judul" id="notes" placeholder="Judul" value="{{ $data->title }}" required>
                <input type="text" name="catatan" placeholder="Catatan (opsional)" value="{{ $data->deskripsi }}">

...
<body>
    <nav class="sidebar">
        <div class ="sidebar-icon ">
            <a href="">
                <img src="img/avatar." alt="" class="profile">
            </a>
        </div>
        <div class="sidebar-icon">
            <i>
...
<main class="main-content">
    <div class="header">
        <div><a class="bi bi-arrow-left-short" href="/Dashboard/2Rekening/UangTunai/index.html" ></a></div>
    ...
    <div class="form">
          ...
          <input type="text" id="notes" placeholder="Judul Pemasukan">

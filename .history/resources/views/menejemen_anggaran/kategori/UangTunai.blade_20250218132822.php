    ...
    <main class="main-content">
        ...
        <div class="main-container">
            ...
            <div class="show-data">
                ...
                <a href="{{ route('edit.pemasukan.pengeluaran', ['type' => 'pemasukan', 'id' => $item->id]) }}">Edit</a>            </div>
            @endforeach
            ...
            <div class="show-data">
                ...
                <a href="{{ route('edit.pemasukan.pengeluaran', ['type' => 'pengeluaran', 'id' => $item->id]) }}">Edit</a>
            </div>            </div>
            @endforeach
        </div>
    </main>

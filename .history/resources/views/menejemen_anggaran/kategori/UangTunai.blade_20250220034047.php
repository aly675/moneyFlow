...
<body>
    <nav class="sidebar">
        ...
        <div class="sidebar-icon">
            <i>
                <a class="bi bi-journal" href="{{route('target.barang.page')}}"></a>
            </i>
        </div>
    </nav>
    ...
    <main class="main-content">
        ...
        <div class="main-container">
            ...
            <div class="show-data">
                ...
                <a href="{{ route('edit.pemasukan.pengeluaran.page', ['type' => 'pemasukan', 'id' => $item->id]) }}">Edit</a>
              </div>
            @endforeach
            ...
            <div class="show-data">
                ...
                <a href="{{ route('edit.pemasukan.pengeluaran.page', ['type' => 'pengeluaran', 'id' => $item->id]) }}">Edit</a>            </div>
            @endforeach
        </div>
    </main>

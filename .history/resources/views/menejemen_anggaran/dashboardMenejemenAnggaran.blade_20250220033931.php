    ...
    <main class="main-content">
        ...
        <div class="main-container">
            <div class="payment-grid">
                <a href="{{route('kategori.UangTunai')}}" class="payment-card">
                ...
                <a href="{{route('kategori.Dana')}}" class="payment-card">
                ...
                <a href="{{route('kategori.BRI')}}" class="payment-card">
                ...
                <a href="{{route('kategori.BCA')}}" class="payment-card">
                ...
                <a href="{{route('kategori.Mandiri')}}" class="payment-card">
                ...
                <a href="{{route('kategori.Gopay')}}" class="payment-card">

...
<body>
    ...
    <main class="main-content">
        ...
        <div class="form">
            ...
            <input type="number" id="jumlah" placeholder="Masukkan jumlah uang" min="0" max="9999999999" oninput="updateFormattedText()">            <input type="text" id="notes" placeholder="Catatan (optional)" required> <!-- Ubah catatan menjadi deskripsi -->

...
function simpanPemasukan() {
    ...
    const title = document.getElementById('title').value; // Ambil nilai judul
    ...
    const data = {
        tanggal,
        kategori,
        title, // Sertakan judul dalam data
        jumlah,
        catatan,
    ...
    .catch(error => {
        ...
        alert('Terjadi kesalahan saat menyimpan pemasukan.');
    });
}
